...
"""
The code of paper with title
Evaluating the Effect of Data Poisoning via Label Flipping on
Traditional and Deep Learning Models for Arabic Offensive Text Detection
"""
...
def get_models(use_class_weights=True, use_real_bert=True):
    ...
    if BERT_AVAILABLE and use_real_bert:
        models['Arabic BERT'] = ArabicBERTModel(
            max_length=64, batch_size=32, epochs=5, learning_rate=3e-5)
        print("✓ Using optimized Arabic BERT (5 epoch, batch=32)")
    else:
